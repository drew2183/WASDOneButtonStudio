...
void CFileCaptureDlg::UpdateStatusBar(UINT frameCount = 0)
{
	...
	switch (m_captureState)
	{
		...
		case CaptureState::WaitingToRecord:
			statusBarString = _T("Press the button to begin recording.");
			break;
		...
		case CaptureState::Recording:
			{
				...
				statusBarString.Format(_T("Recording - Duration %d:%02d:%02d:%03d - Press the button to stop recording"), hours, minutes, seconds, frames);
			}
			break;
	}
